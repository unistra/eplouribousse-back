...
class ResultantSheetAvailableNotificationTest(TestCase):
    """Test resultant sheet available notification"""
    ...
    def test_resultant_sheet_available_sends_notification(self):
    ...
    def test_resultant_sheet_available_excludes_excluded_collections(self):
    ...
    def test_resultant_sheet_available_respects_user_settings(self):
    ...
    def test_resultant_sheet_available_respects_project_settings(self):
    ...
    def test_resultant_sheet_available_multiple_instructors(self):
    ...
    def test_resultant_sheet_available_no_instructors(self):
    ...
    def test_resultant_sheet_available_not_called_on_bound_validation(self):
